              ...
              <motion.button
                ...
                className={`px-5 py-2.5 rounded-lg font-medium transition-all border ${
                  activeCategory === category
                    ...
                    : 'cyber-glass-card text-muted-text hover:text-main-text border-cyber-border hover:border-tech-blue/50'
                }`}
              >
                {category}
              </motion.button>
        ...
        {selectedProject && (
          ...
          >
            <motion.div
              ...
              className="cyber-glass-card max-w-3xl w-full max-h-[90vh] overflow-y-auto"
            ...
            >
              ...
              <div className="relative aspect-video">
                ...
                <button
                  onClick={() => setSelectedProject(null)}
                  className="absolute top-4 right-4 w-10 h-10 rounded-full cyber-glass-card flex items-center justify-center text-main-text hover:text-tech-blue transition-colors"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
              ...
              <div className="p-8">
                ...
                {/* Tech Stack */}
                <div className="mb-6">
                  <h4 className="font-heading font-semibold mb-3 text-silver">Technologies Used</h4>
                  <div className="flex flex-wrap gap-2">
                    {selectedProject.techStack.map((tech) => (
                      <span
                        key={tech}
                        className="px-3 py-1 rounded-lg bg-tech-blue/10 border border-tech-blue/30 text-tech-blue text-sm"
                      >
                        {tech}
                      </span>
                    ))}
                ...
                {/* Outcome */}
                <div className="cyber-glass-card p-4 mb-6 border-cyber-neon/30">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Link
                    to="/contact"
                    className="px-6 py-3 rounded-lg border border-silver/30 text-silver hover:bg-silver/10 transition-all inline-flex items-center justify-center gap-2"
                  >
